 ...
 * The {@code ExceptionHandlingController}  is used to handle exceptions globally.
 *
 */
...
public class BookStoreServiceImpl implements IBookStoreService {
	...
	public BookDetailsEntity findBook(PurchaseBookRequestDto purchaseDto) {
		...
		if(book == null) {
			LOGGER.info("Book Not Found with with details ISBN = {}, Author = {} or Title = {} !!!", purchaseDto.getIsbn(), purchaseDto.getAuthor(), purchaseDto.getTitle());
			throw new ResourceException("Book", "ISBN | Author | Title ", purchaseDto.getIsbn()+" , "+ purchaseDto.getAuthor()+ " , " + purchaseDto.getTitle());
		}
	...
	public void checkBookQuantity(PurchaseBookRequestDto purchaseDto, int bookQuantity) {
		if (bookQuantity <= 0 || bookQuantity < purchaseDto.getQuantity()) {
			LOGGER.info("Book quantity with ISBN = {}, Author = {}, Title = {} is not sufficient! Quantity avialble = {} !", purchaseDto.getIsbn(), purchaseDto.getAuthor(), purchaseDto.getTitle() , bookQuantity);
			throw new ResourceException("Book", "ISBN | Author | Title ", purchaseDto.getIsbn()+" , "+ purchaseDto.getAuthor()+ " , " + purchaseDto.getTitle());
		}
	}
